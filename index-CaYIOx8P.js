    ...
    , dE = () => {
        ...
        return c.jsxs("div", {
            ...
            children: [c.jsxs("section", {
                ...
                children: [c.jsx("div", {
                    className: "absolute inset-0 bg-gradient-to-br from-[#E6F7FF] via-[#C7ECFF] to-[#9CD7FF]"
                }), c.jsx("div", {
...
const EA = () => {
    ...
    , AA = [{
        ...
        id: 2,
        title: "Điều kiện ra đời CNXH",
        subtitle: "Điều kiện ra đời",
        description: "Sự ra đời của CNXH theo chủ nghĩa Mác - Lênin.",
                ...
                children: [c.jsx("div", {
                    ...
                    children: AA.map((e, t) => {
                      ...
                      `,
                          ...
                          rotate-12 group-hover:rotate-0 transition-all duration-300
                        `,
                                            style: {
    ...
    , LA = [{
        ...
        blocks: [{
            ...
            content: [
                "CNXH mở ra một giai đoạn phát triển mới của nhân loại, nảy sinh từ lòng xã hội tư bản.",
            ...
            content: [
                "Mâu thuẫn cơ bản của TBCN: giữa tính xã hội hóa của sản xuất và chế độ chiếm hữu tư nhân về tư liệu sản xuất.",
